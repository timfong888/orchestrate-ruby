module Test
  ...
  module ProceduralSearch
    ...
    def test_procedural_search
      ...
      # setup
      Test.output_message(test_root_name, "Test setup")
      ...
      # test
      Test.output_message(test_root_name, "TEST START")
      ...
      # cleanup
      Test.output_message(test_root_name, "Test cleanup")
